...
public class InitializeDurationTable {
    ...
    public TableView initialize(){
        TableColumn<Duration, Integer> visitColumn = new TableColumn("Visit");
        TableColumn<Duration, String> durationColumn = new TableColumn("Duration");
        TableColumn<Duration, Float> priceCardColumn = new TableColumn("Price for cards");
        TableColumn<Duration, Float> priceCashColumn = new TableColumn("Price for cash");
