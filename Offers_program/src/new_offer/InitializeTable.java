...
public class InitializeTable {
    ...
    public TableView initialize(){
        ...
        TableColumn<Treatment,Integer> quantityColumn = new TableColumn<>("Quantity");
        TableColumn<Treatment,Float> priceColumn = new TableColumn<>("Price");
        TableColumn<Treatment,Integer> discountColumn = new TableColumn<>("Discount(%)");
        TableColumn<Treatment,Float> totalColumn = new TableColumn<>("Total");
        TableColumn<Treatment,Integer> visitColumn = new TableColumn<>("Visit");
