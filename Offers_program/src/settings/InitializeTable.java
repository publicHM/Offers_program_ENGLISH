...
public class InitializeTable {
    ...
    public TableView initialize(){
        TableColumn<AddData,String> languageOneColumn = new TableColumn("Language 1");
        TableColumn<AddData,Float> priceOneColumn = new TableColumn<>("Price 1");
        TableColumn<AddData,Integer> discountOneColumn = new TableColumn<>("Discount 1");
        TableColumn<AddData,String> languageTwoColumn = new TableColumn("Language 2");
        TableColumn<AddData,Float> priceTwoColumn = new TableColumn<>("Price 2");
        TableColumn<AddData,Integer> discountTwoColumn = new TableColumn<>("Discount 2");
